...
/**
 * Modern Dashboard
 * ERP v2 - Dashboard Configuration Engine + Modern UI
 */
...
$pageTitle = $currentRoleInfo['label'] . ' - ERP v2';
?>
<!DOCTYPE html>
<html lang="th">
<head>
            ...
            <div class="page-content">
                ...
                <div style="margin-top: 24px; padding: 16px 20px; background: var(--white); border-radius: var(--border-radius-lg); box-shadow: var(--shadow);">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                        ...
                        <div>
                            <a href="<?= BASE_URL ?>/index.php" style="color: var(--gray-500); text-decoration: none; font-size: 0.85rem;">
                                <i class="bi bi-arrow-left"></i> Back to Classic View
                            </a>
                        </div>
                    </div>
                </div>
