...
class BookingConflict {
     ...
     * @param string $type 'Serial' or 'Person'
    ...
    public function hasConflict($type, $id, $startTime, $endTime, $excludeRefId = null) {
        ...
        // We use a simple select first. 
        // For strict locking, the caller should have strictly locked the parent resource or we use logic in booking.
